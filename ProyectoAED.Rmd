...
>>>>>>> f8e5415b80749b6d80314dbc2a58ea5f402d0ae7
...
Tras la ejecución de los scripts de limpieza, obtenemos el *dataset* `dataset_limpio`. Este conjunto de datos contiene *`r nrow(dataset_limpio)`* observaciones (cada una representando a un estudiante que reportó gastos) y *`r ncol(dataset_limpio)`* variables limpias y listas para el análisis.
