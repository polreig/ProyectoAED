...
EGHE_2019<-EGHE_2019%>%mutate(NEST=factor(NEST, levels=c(0, 1, 2, 3, 4, 5), labels=c("No realiza estudios", "Educación Infantil", "Educación Primaria", "Educación Secundaria", "Educación Superior", "Otros estudios sin nivel académico")))
```
...
library(dplyr)
EGHE_2019<-EGHE_2019%>%
  filter(!(is.na(C01)&ESTUDIANTE=="Sí"))
